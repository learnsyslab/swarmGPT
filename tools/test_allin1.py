...
Runs `allin1.analyze` on one MP3 from `music/` and prints the result plus timing
and device info. Intended to be run on the Linux GPU box to verify that the
pixi install pulled CUDA-enabled PyTorch + NATTEN + madmom correctly.
